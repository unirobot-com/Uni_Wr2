...
class MotorControl:
    ...
    def calculate_speed(self):
        ...
        # self.current_speed = ((delta_position / self.once_cycle_pulse_count) * self.wheel_circumference ) / 0.1 
        self.current_speed = ((delta_position / self.once_cycle_pulse_count) * self.wheel_circumference )
        print("delta:", delta_position, "circle:", (delta_position / self.once_cycle_pulse_count))
        print("odom:", ((delta_position / self.once_cycle_pulse_count) * self.wheel_circumference ))
        print("curspeed:", self.current_speed)
    ...
    def run(self):
        try:
            ...
            while True:
                ...
                print(currrent_speed, self.target_speed, output)
                time.sleep(0.1)
...
def main():
    ...
    left_motor.target_speed = 0.01  # 设置目标速度为0.05 m/s
    left_motor.run()
