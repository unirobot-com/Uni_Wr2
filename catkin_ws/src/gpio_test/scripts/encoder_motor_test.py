...
if __name__ == "__main__":
    ...
    # encoder_motor_handler = EncoderMotorHandler(4, 17, 18, 23)
    # encoder_motor_handler = EncoderMotorHandler(13, 16, 5, 6)
    encoder_motor_handler = EncoderMotorHandler(19, 20, 12, 18)
    # 设置中等速度和正转方向
    encoder_motor_handler.set_motor_speed(0.8, -1)
